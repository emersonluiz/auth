 ...
 * dirived from ng2-cookies (https://github.com/BCJTI/ng2-cookies) by Felipe Rebelo Lopes
 */
@Injectable()
export class CookieService {
	 ...
	 */
    public setCookie(name: string, value: string, expires?: number, path?: string, domain?: string): void {
        let myWindow: any = window
